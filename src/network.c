...
const char *l_name[] = { "CONVOLUTIONAL", "DECONVOLUTIONAL", "CONNECTED", "MAXPOOL", "SOFTMAX", "DETECTION", "DROPOUT", "CROP",
"ROUTE",
"COST",
"NORMALIZATION",
"AVGPOOL",
...
float train_network_datum(network *net)
{
    *net->seen += net->batch;
    ...
    time_ms += (stop.tv_nsec - start.tv_nsec)/1000;
    ...
    time_ms_backward += (stop.tv_nsec - start.tv_nsec)/1000;
